...
export declare function nodeGraphStageJson(_name: string): string | null;
export declare function nodeGraphStage<T = unknown>(_name: string): T | null;
export declare function nodeGraphStagePath(_name: string): string | null;
