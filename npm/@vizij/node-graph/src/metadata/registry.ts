...
const registry: Registry = {
  ...
  "nodes": [
    ...
    },
    {
      ...
      "name": "Simple Noise",
      "category": "Noise",
      "doc": "Hash-based 2D value noise returning [-1, 1]; deterministic for identical inputs and seed.",
      "inputs": [
        {
          "id": "x",
          "ty": "float",
    ...
    },
    {
      ...
      "name": "Perlin Noise",
      "category": "Noise",
      "doc": "Classic 2D Perlin gradient noise returning [-1, 1]; deterministic for identical inputs and seed.",
      "inputs": [
        {
          "id": "x",
          "ty": "float",
    ...
    {
      "type_id": "simplexnoise",
      "name": "Simplex Noise",
      "category": "Noise",
      "doc": "2D simplex noise returning [-1, 1]; deterministic for identical inputs and seed.",
      "inputs": [
        {
          "id": "x",
          "ty": "float",
    ...
    },
    {
      ...
      "variadic_outputs": {
        ...
        "ty": "any",
        "label": "Mutated",
        "doc": "One of the call's mutable (out) parameters after the invocation: the one whose id is the slot's key in params.record_keys. Latched with the status.",
        "min": 0,
        "keyed": true
      },
      "params": []
