...
fn main() -> anyhow::Result<()> {
    ...
    // Load fixture from animation test_fixtures (loop_window.json)
    let json = fs::read_to_string("crates/animation/test_fixtures/loop_window.json")?;
    ...
    // Optionally prebind with a simple resolver if needed (skipped here)
