...
//! the running device through its [`RuntimeHandle`]; the device restarts on
...
use vizij::native::RuntimeHandle;

pub struct OpenPlugin(pub RuntimeHandle);
