...
- **Purpose**: Deterministic animation engine powering wasm and Arora module integrations.
...
- **When editing**:
  ...
  - Keep `Engine` and `InstanceCfg` constructors backwards compatible; the animation module and wasm wrappers depend on them.
